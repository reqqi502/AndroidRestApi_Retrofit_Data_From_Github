package com.example.androidrestapi_retrofit.model;
...
import com.example.androidrestapi_retrofit.R;
...
public class UsersListViewModel extends ArrayAdapter<GitUser> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView imageViewUser = listViewItem.findViewById(R.id.imageViewUser);
